...
//returns: handle
//Add a score
var url="http://gamejolt.com/api/game/v1/scores/add/?game_id="+gj_gameid+"&username="+gj_user+"&user_token="+gj_token+"&table_id="+argument0+"&score="+string(argument1)+"&sort="+argument2+"&extra_data="+argument3;

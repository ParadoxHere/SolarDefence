...
//returns: handle
//Add a score
var url="http://gamejolt.com/api/game/v1/scores/add/?game_id="+gj_gameid+"&guest="+argument4+"&table_id="+argument0+"&score="+string(argument1)+"&sort="+argument2+"&extra_data="+argument3;
